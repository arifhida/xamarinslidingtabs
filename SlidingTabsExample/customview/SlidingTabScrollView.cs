...
using SlidingTabsExample.fragments;
using SlidingTabsExample.adapter;

namespace SlidingTabsExample.customview
{
    class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public SlidingTabScrollView(Context context, IAttributeSet attrs, int defStyleAttr) : base(context, attrs, defStyleAttr)
        {
